...
import { Laptop, Shirt, FootprintsIcon, ShoppingBag, Home, Dumbbell } from "lucide-react";
...
const ShopHub: React.FC = () => {
  ...
  const categories = [
    ...
    { name: "Footwear", icon: FootprintsIcon, count: 89 },
...
`}
      ...
      <header className="sticky top-0 z-50 backdrop-blur-glass border-b border-white/20 animate-slide-in-down">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-3 pb-5">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="!rounded-button whitespace-nowrap cursor-pointer md:hidden p-3 rounded-xl hover:bg-gray-100 transition-all duration-300"
        ...
        {/* Enhanced Navigation */}
        <nav className="border-t border-white/20 bg-white/60 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 md:hidden animate-fade-in-scale">
          <div
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8">
            ...
            <div className="backdrop-blur-glass rounded-2xl shadow-xl p-8 sticky top-32">
              <div className="flex items-center justify-between mb-8">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="!rounded-button whitespace-nowrap cursor-pointer lg:hidden p-2 rounded-lg hover:bg-red-50"
          ...
          >
            {/* Enhanced Sort and Filter Toggle */}
            <div className="flex items-center justify-between mb-8 p-6 backdrop-blur-glass rounded-2xl">
              <div className="flex items-center space-x-4">
                ...
                <p className="text-sm font-medium text-gray-700 bg-white/60 px-4 py-2 rounded-full">
                  Showing{" "}
              ...
              {sortedProducts.map((product, index) => (
                ...
                >
                  <CardContent className="p-0">
                    ...
                    <div className="p-6">
                      <h3 className="font-bold text-gray-900 mb-3 text-lg line-clamp-2 hover:text-blue-600 transition-colors duration-300">
                        {product.name}
                      </h3>
                      {/* Enhanced Rating */}
                      <div className="flex items-center mb-3">
                        <div className="flex items-center bg-gradient-to-r from-yellow-400 to-orange-400 px-2 py-1 rounded-full mr-2">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-2">
                          ...
                          {product.originalPrice && (
                            <span className="text-sm text-gray-500 line-through bg-gray-100 px-2 py-1 rounded-full">
                              ${product.originalPrice}
                            </span>
                          )}
                        </div>
            ...
            >
              <div className="text-center mb-10">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Discover more amazing products carefully curated just for you
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {products.slice(0, 4).map((product, index) => (
                  <Card
                    key={product.id}
                    className="group hover:shadow-2xl transition-all duration-500 backdrop-blur-glass border-2 border-white/30 rounded-2xl overflow-hidden animate-fade-in-scale"
                  ...
                  >
                    <CardContent className="p-0">
                      ...
                      <div className="p-4">
                        <h3 className="font-semibold text-gray-900 mb-2 text-sm line-clamp-2 group-hover:text-blue-600 transition-colors duration-300">
                          {product.name}
                        </h3>
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            className="!rounded-button whitespace-nowrap cursor-pointer h-8 px-3 text-xs font-medium border-2 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 hover:text-white hover:border-transparent transition-all duration-300"
                            onClick={() => addToCart(product)}
                          >
                            <Plus className="mr-1"/>
                            Add
            ...
            >
              ...
              <div className="backdrop-blur-glass rounded-2xl shadow-xl p-8 border-2 border-white/30">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <Button
                    variant="outline"
                    className="!rounded-button whitespace-nowrap cursor-pointer px-6 py-3 border-2 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:border-blue-300 transition-all duration-300"
                  >
                    <Pen className="mr-2"/>
                    Write a Review
                  </Button>
                ...
                <div className="space-y-6">
                  {reviews.map((review, index) => (
                    <div
                      key={review.id}
                      className="border-b border-gray-200/50 pb-6 last:border-b-0 animate-fade-in-scale"
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center mb-3">
                            <div className="flex items-center bg-gradient-to-r from-yellow-400 to-orange-400 px-3 py-1 rounded-full mr-3">
                              {[...Array(5)].map((_, i) => (
                                <Star key={i} className={`${i < review.rating
                                      ? "text-white"
                                      : "text-white/40"}`}/>
                              ))}
                            </div>
      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden animate-fade-in-scale">
          ...
          ></div>
          <div className="absolute right-0 top-0 h-full w-96 backdrop-blur-glass shadow-2xl border-l-2 border-white/20">
            <div className="flex flex-col h-full">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-2 mt-3">
                            <Button
                              variant="outline"
                              size="sm"
                              className="!rounded-button whitespace-nowrap cursor-pointer h-8 w-8 p-0 rounded-lg border-2 hover:bg-red-50 hover:border-red-300 transition-all duration-300"
                              onClick={() =>
                                updateQuantity(item.id, item.quantity - 1)
                              }
                            >
                              <Minus className="text-xs text-red-500"/>
                            </Button>
                            <span className="text-sm font-bold bg-white/60 px-3 py-1 rounded-lg min-w-[2rem] text-center">
                              {item.quantity}
                            </span>
                            <Button
                              variant="outline"
                              size="sm"
                              className="!rounded-button whitespace-nowrap cursor-pointer h-8 w-8 p-0 rounded-lg border-2 hover:bg-green-50 hover:border-green-300 transition-all duration-300"
                              onClick={() =>
                                updateQuantity(item.id, item.quantity + 1)
                              }
                            >
                              <Plus className="text-xs text-green-500"/>
                            </Button>
                          </div>
                        </div>
                        <Button
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl">
            <div className="bg-white rounded-2xl shadow-2xl p-8">
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">  
                  <div className="p-1 flex justify-end pt-0 mt-0">
                    <Button
                  variant="ghost"
                  size="sm"
                  className="!rounded-button whitespace-nowrap cursor-pointer p-2 rounded-lg hover:bg-red-50 transition-colors duration-300"
                ...
                >
                  ...
                  <form className="space-y-6">
                    ...
                    <Button
                      className="!rounded-button whitespace-nowrap cursor-pointer w-full py-6 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
                      onClick={(e) => {
                        e.preventDefault();
                        const button = e.currentTarget;
                        button.classList.add("animate-pulse");
                  ...
                  <div className="mt-6">
                    <div className="flex items-center justify-center space-x-4">
                      <FontAwesomeIcon icon={faCcVisa} className="text-2xl text-blue-600"/>
                      <FontAwesomeIcon icon={faCcMastercard} className="text-2xl text-red-500"/>
                      <FontAwesomeIcon icon={faCcAmex} className=" text-blue-500"/>
                      <FontAwesomeIcon icon={faCcDiscover} className="text-2xl text-orange-500"/>
                    </div>
                    <p className="text-center text-sm text-gray-500 mt-4">
                      <LockKeyhole className="text-green-500 mr-1"/>
